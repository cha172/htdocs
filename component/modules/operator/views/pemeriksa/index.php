...
<section id="page-content">
    ...
    <p>
        <?=Html::a('Create Pemeriksa', ['create'], ['class' => 'btn btn-success'])?>
    </p>
    ...
    <?=GridView::widget(['dataProvider' => $dataProvider,'filterModel' => $searchModel,'columns' => [['class' => 'yii\grid\SerialColumn'],'nip_pemeriksa','nama',['class' => 'yii\grid\ActionColumn']]]);?>
