...
echo "<div id='modalContent'>";?>
                   <?php $form = ActiveForm::begin(['layout'=>'horizontal','id'=>'fkom']); ?>
                    ...
                    <?= $form->field($kompartemen, 't1')->textInput() ?>
               	    <?= $form->field($kompartemen, 't2')->textInput() ?>
                    <?= $form->field($kompartemen, 't3')->textInput() ?>
                	<?= $form->field($kompartemen, 't4')->textInput() ?>
                    <?= $form->field($kompartemen, 'T')->textInput() ?>
