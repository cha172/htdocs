    ...
    return {
        ...
        barChartChartJS: function () {
            ...
            if($('#chartjs-bar-chart-1').length){
                ...
                var myLine = new Chart(document.getElementById("chartjs-bar-chart-1").getContext("2d")).Bar(barChartData);
            }
            
            if($('#chartjs-bar-chart-2').length){
                var barChartData = {
                    labels : ["January","February","March","April","May","June","July"],
                    datasets : [
                        {
                ...
                var myLine = new Chart(document.getElementById("chartjs-bar-chart-2").getContext("2d")).Bar(barChartData);
            }            
        },
