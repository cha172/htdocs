...
class Identitas extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['volume_nominal', 'jml_kompartemen', 'id_pemilik', 'id_metode', 'tahun', 'surat', 'lob_jarum', 'lob_kawat_indeks', 'lob_kawat_manhole', 'benda_tum','lob_kawat_chasis','suhu_dasar','diajukan','edit','hapus','request_edit','request_hapus'], 'integer'],
            [['tgl_pemeriksaan','tgl_sertifikat','kom'], 'safe'],
            [['uttp'], 'string', 'max' => 5],
