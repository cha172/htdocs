                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        ['label'=>'File',
                            'format'=>'raw',
                            'value'=>function($data){
                                return Html::a('Download','/'.Yii::$app->controller->module->id.'/sertifikat/download?id='.$data->id_identitas,['id'=>'btndownload'.$data->id_identitas,'class'=>'btn btn-xs btn-primary','data-pjax'=>0])  ;
                            }
                        ],
