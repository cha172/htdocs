                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    <i class="fa fa-envelope"></i> support@stif.id
                                                </li>
                                                <li>
                                                    <i class="fa fa-mobile"></i> +62812-999-0816
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li>
                                            <div class="media-list working">
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Daddy Botak">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Sarah Tingting">
                                                        <i class="offline"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Claudia Cinta">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Harry Potret">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Jeck Joko">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Tenny Imoet">
                                                        <i class="busy"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Leli Madang">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Rebecca Cabean">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Sishy Mawar">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="/images/logo.png" class="img-circle" alt="Mbah Roso">
                                                        <i class="away"></i>
                                                    </span>
                                                    <span class="media-body">
